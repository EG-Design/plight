    ...
    <main>
      <div class="databank">
        ...
        <div class="card">
          ...
          <form>
            <button type="submit" onclick="overviewlogin(event)">
              CONFIRM
            </button>
        ...
        <div class="card">
          ...
          <form>
            <button type="submit" onclick="universelogin(event)">
              CONFIRM
            </button>
        ...
        <div class="card">
          ...
          <form>
            <button type="submit" onclick="factionslogin(event)">
              CONFIRM
            </button>
        ...
        <div class="card">
          ...
          <p>
            Data cell [WARNING FALSE CORE] - false core warning disregard, black
            hole reassembling data to 2nd cruiser.
          </p>
          <form form>
            <button type="submit" onclick="maplogin(event)">CONFIRM</button>
        ...
        <div class="card">
          ...
          <p>
            []]II[]] [Ċ̶̢̥̬̬͎̹̭̏͜ͅO̸̡̧̬͎̻̼̘̙̔̒͋̔̽ͅR̴̡̙̱̦̣̓̇̄̓̊́̂̌̈́R̷̢̬̩̲̗̯͚̱̓̂U̸͓̙̦͆̆͊̕P̵̛̟̳͕͊̀̏͗͒͘T̷̤͉̗̪͎͌͊͝ͅ] - III[]]II]][[II]] Ḑ̴̨̦̟̖̜̺̥͈̀̊Ȩ̸͓̪͕͉̰̣͓͋̾L̷̻̤̤̪̞͐E̸̯͓̞̫̲͙̙̘̫̳͆̓͝T̶̹̦̳̭̳̪̂͐͗̕E̶̢̯̯̼͕̪̜͕͝ []]]]II ][[II] ]][[II]
            I]I[]].
          </p>
          <form form>
            <button type="submit" onclick="corruptlogin(event)">
              II()[II]]I()[
            </button>
        ...
        <div class="card">
          ...
          <form>
            <button type="submit" onclick="templatelogin(event)">
              CONFIRM
            </button>
